...
resource "aws_iam_role" "eksclusterrole" {
  name = "${var.prefix}-eks-clusterrole"
...
resource "aws_iam_role_policy_attachment" "upgrad-AmazonEKSClusterPolicy" {
...
resource "aws_iam_role_policy_attachment" "upgrad-AmazonEKSVPCResourceController" {
